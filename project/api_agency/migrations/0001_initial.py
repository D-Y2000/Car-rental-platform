# Generated by Django 5.0.2 on 2024-02-17 09:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('agency_owner', 'Agency Owner'), ('agency_admin', 'Agency Admin'), ('agency_employer', 'Agency Employer'), ('default', 'Default')], default='default', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owned_by', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='my_cars', to='api_agency.branch')),
